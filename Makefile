...
SOURCES += src/command/e2_terminal.c src/command/e2_terminal_context.c src/command/e2_terminal_search.c src/command/e2_terminal_shell.c src/command/e2_terminal_vte$(VTE_BACKEND).c
endif
